...
import com.cts.turmeric.runtime.common.impl.binding.jaxb.jackson.JAXBJSONDeserializerFactory;
import com.cts.turmeric.runtime.common.impl.binding.jaxb.jackson.JAXBJSONSerializerFactory;
import com.sun.xml.bind.v2.runtime.XMLSerializer;


public class JAXBJacksonSerDeserTest extends BaseSerDeserTest {
	@Before
	...
	public void jaxbJsonBasic() throws Exception {				
		...
		DataBindingDesc dbDesc = new DataBindingDesc("JACKSON", SOAConstants.MIME_JSON, m_serFactory,
	...
	public static void main(String[] args) {
		try {
			JAXBJacksonSerDeserTest test = new JAXBJacksonSerDeserTest();
			test.startServer();
			test.setUpFactoriesAndConfig();
			test.setUp();
			test.jaxbJsonBasic();			
			test.stopServer();
		} catch (Exception e) {
