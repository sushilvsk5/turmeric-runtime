...
import com.cts.turmeric.runtime.common.impl.binding.jaxb.aalto.JAXBXMLDeserializerFactory;
import com.cts.turmeric.runtime.common.impl.binding.jaxb.aalto.JAXBXMLSerializerFactory;


public class JAXBAaaltoXMLSerDeserTest extends BaseSerDeserTest {
	public JAXBAaaltoXMLSerDeserTest() {
		super();
	}

	@Before
	public void setUpFactoriesAndConfig() throws Exception {
		ServiceConfigManager.getInstance().setConfigTestCase("cts");
