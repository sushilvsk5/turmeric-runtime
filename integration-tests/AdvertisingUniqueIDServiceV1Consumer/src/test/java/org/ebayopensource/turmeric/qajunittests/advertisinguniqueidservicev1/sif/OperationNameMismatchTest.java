...
public class OperationNameMismatchTest {
	...
	protected final Logger logger = LoggerFactory
			.getLogger(OperationNameMismatchTest.class);

	@BeforeClass
	public static void setUp() throws ServiceException {
		AdvertisingUniqueIDServiceV1SharedConsumer client = new AdvertisingUniqueIDServiceV1SharedConsumer(
	...
	public void testXMLIncorrectMethod() {
		...
		/*
		 * try { queryParams.put("X-TURMERIC-SERVICE-NAME",
		 * "{http://www.ebay.com/marketplace/advertising/v1/services}UniqueIDService"
		 * );
		 ...
		 * queryParams.put("X-TURMERIC-SERVICE-VERSION","1.0.0"); body =
		 * "<?xml version='1.0' encoding='UTF-8'?><getTransportHeadersError xmlns=\"http://www.ebay.com/marketplace/advertising/v1/services\"><in>Test</in></getTransportHeadersError>"
		 * ; Request request = new
		 * Request("http://localhost:8080/services/advertise/UniqueIDService/v1"
		 * ); response = http.getResponseDB(request, queryParams, body, "POST");
		 * Assert.assertTrue(response.getBody().contains("null"));
		 * System.out.println(response.getBody()); } catch (Exception e) {
	...
	public void testIncorrectPayload() {
		...
		/*
		 * try { queryParams.put("X-EBAY-SOA-SERVICE-NAME",
		 * "{http://www.ebay.com/marketplace/advertising/v1/services}UniqueIDService"
		 * );
		 ...
		 * queryParams.put("X-EBAY-SOA-SERVICE-VERSION","1.0.0"); body =
		 * "<?xml version='1.0' encoding='UTF-8'?><getTransportHeadersError xmlns=\"http://www.ebay.com/marketplace/advertising/v1/services\"><in>Test</getTransportHeadersError>"
		 * ; Request request = new
		 * Request("http://localhost:8080/services/advertise/UniqueIDService/v1"
		 * ); response = http.getResponseDB(request, queryParams, body, "POST");
		 ...
		 * Assert
		 * .assertTrue(response.getBody().contains("<errorId>5014</errorId>"));
		 * 
		 * 
		 * } catch (Exception e) {
		 * assertTrue("Error - No Exception should be thrown ", false); }
	...
	public void testJSON() {
		 ...
		 * queryParams.put("X-EBAY-SOA-SERVICE-VERSION","1.0.0"); body =
		 * "{\"getTransportHeadersError\":[{\"in\":[\"Test\"]}]}"; Request
		 * request = new
		 * Request("http://localhost:8080/services/advertise/UniqueIDService/v1"
		 * ); response = http.getResponseDB(request, queryParams, body, "POST");
		 * // System.out.println(response.getBody());
		 * Assert.assertTrue(response.
		 * getBody().contains("{\"getTransportHeadersResponse\":]}")); } catch
		 * (Exception e) { assertTrue("Error - No Exception should be thrown ",
		 * false); }
		 */
		logger.debug("--- testJSON ---");
