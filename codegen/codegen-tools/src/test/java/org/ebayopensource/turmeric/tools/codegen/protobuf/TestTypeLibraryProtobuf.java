...
public class TestTypeLibraryProtobuf extends AbstractServiceGeneratorTestCase {
	...
	private File getPathOfFile(String name) {
		return TestResourceUtil.getResource("xsd/" + name);
	...
	public void testCase1() throws Exception {
		...
		String[] testArgs = { "-servicename", "ShippingService", "-wsdl",
				wsdlFile.getAbsolutePath(), "-genType",
				"ValidateXSDsForNonXSDFormats", "-xsdPathsForValidation",
				"xsd/TestXsd.xsd", "-nonXSDFormats", "protobuf", "-pr",
	...
	public void testCase2() throws Exception {
		...
		String[] testArgs = { "-servicename", "ShippingService", "-wsdl",
				wsdlFile.getAbsolutePath(), "-genType",
				"ValidateXSDsForNonXSDFormats", "-xsdPathsForValidation",
				"xsd/TestXsd.xsd", "-pr", destDir, "-dest", destDir
	...
	public void testCase3() throws Exception {
		...
		String[] testArgs = { "-servicename", "ShippingService", "-wsdl",
				wsdlFile.getAbsolutePath(), "-genType",
				"ValidateXSDsForNonXSDFormats", "-xsdPathsForValidation",
				"xsd/TestXsd.xsd,xsd/TestXsd1.xsd", "-nonXSDFormats",
				"protobuf", "-pr", destDir, "-dest", destDir
	...
	public void testCase4() throws Exception {
		...
		String[] testArgs = { "-servicename", "ShippingService", "-wsdl",
				wsdlFile.getAbsolutePath(), "-genType",
				"ValidateXSDsForNonXSDFormats", "-xsdPathsForValidation",
				"xsd/TestXsd2.xsd", "-nonXSDFormats", "protobuf", "-pr",
				destDir, "-dest", destDir
	...
	public void testCase5() throws Exception {
		...
		String[] testArgs = { "-servicename", "ShippingService", "-wsdl",
				wsdlFile.getAbsolutePath(), "-genType",
				"ValidateXSDsForNonXSDFormats", "-xsdPathsForValidation",
				"xsd/TestXsd3.xsd", "-nonXSDFormats", "protobuf", "-pr",
				destDir, "-dest", destDir
	...
	public void testCase6() throws Exception {
		...
		String[] testArgs = { "-servicename", "ShippingService", "-wsdl",
				wsdlFile.getAbsolutePath(), "-genType",
				"ValidateXSDsForNonXSDFormats", "-xsdPathsForValidation",
				"xsd/SupportedXsd.xsd", "-nonXSDFormats", "protobuf", "-pr",
				destDir, "-dest", destDir
	...
	public void testCase7() throws Exception {
		...
		String[] testArgs = { "-servicename", "ShippingService", "-wsdl",
				wsdlFile.getAbsolutePath(), "-genType",
				"ValidateXSDsForNonXSDFormats", "-xsdPathsForValidation",
				xsd1.getAbsolutePath(), "-nonXSDFormats", "protobuf", "-pr",
				destDir, "-dest", destDir
	...
	public void testCase8() throws Exception {
		...
		String[] testArgs = {
				...
				"-genType",
				"ValidateXSDsForNonXSDFormats",
				"-xsdPathsForValidation",
				"jar:file:\\"
						+ xsd1.getAbsolutePath()
						+ "/SOATestUserTypeLibrary.jar!/types/RegistrationInfoType.xsd,jar:file:\\"
						+ xsd1.getAbsolutePath()
						+ "/SOATestUserTypeLibrary.jar!/types/UserInfoType.xsd",
				"-nonXSDFormats", "protobuf", "-pr", destDir, "-dest", destDir
	...
	public void testCase9() throws Exception {
		...
		String[] testArgs = { "-servicename", "ShippingService", "-wsdl",
				wsdlFile.getAbsolutePath(), "-genType",
				"ValidateXSDsForNonXSDFormats", "-xsdPathsForValidation",
				"types/RegistrationInfoType.xsd,types/UserInfoType.xsd",
				"-nonXSDFormats", "protobuf", "-pr", destDir, "-dest", destDir
	...
	// URL url = new
	// URL("jar:file://+xsd1.getAbsolutePath() +"/SOATestUserTypeLibrary.jar!/UserInfoType.xsd);
	// RegistrationInfoType
	// jar:file://+xsd1.getAbsolutePath()
	// +"/SOATestUserTypeLibrary.jar!/RegistrationInfoType.xsd
