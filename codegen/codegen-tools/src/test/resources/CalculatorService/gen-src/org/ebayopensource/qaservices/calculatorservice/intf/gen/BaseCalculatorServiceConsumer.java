...
public class BaseCalculatorServiceConsumer {
     ...
     * 
     */
    public BaseCalculatorServiceConsumer(String clientName, Class caller, boolean useDefaultClientConfig)
        throws ServiceException
    {
     ...
     * 
     */
    public BaseCalculatorServiceConsumer(String clientName, String environment, Class caller, boolean useDefaultClientConfig)
        throws ServiceException
    {
        if (clientName == null) {
        ...
        ClassLoaderRegistry.instanceOf().registerServiceClient(m_clientName, m_environment, SVC_ADMIN_NAME, (BaseCalculatorServiceConsumer.class), caller, m_useDefaultClientConfig);
    }
